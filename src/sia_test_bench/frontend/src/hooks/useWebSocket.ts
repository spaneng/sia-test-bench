            ...
            if (data.type === 'data') {
              ...
              if (data.test === 'max_pressure_verify') {
                ...
                setMaxFlowRegulateStatus({
                  ...
                  pressureTolerance: data.pressure_tolerance ?? null,
                  currentFlow: data.current_flow ?? null,
                  currentFlowMa: data.current_flow_ma ?? null,
                  targetFlow: data.target_flow ?? null,
                  currentLevelMm: data.current_level_mm ?? null,
                  targetLevelMm: data.target_level_mm ?? 800,
              ...
              if (data.maxFlowRegulate) {
                ...
                store.setMaxFlowRegulateStatus({
                  ...
                  pressureTolerance: r.pressure_tolerance ?? null,
                  currentFlow: r.current_flow ?? null,
                  currentFlowMa: r.current_flow_ma ?? null,
                  targetFlow: r.target_flow ?? null,
                  currentLevelMm: r.current_level_mm ?? null,
                  targetLevelMm: r.target_level_mm ?? 800,
